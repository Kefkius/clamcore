...
TransactionOut.prototype.isNullOutput = function isNullOutput() {
  return (this.getScript().chunks.length == 0);
};
...
Transaction.prototype.isStake = function() {
  return this.ins.length == 1 && this.outs.length == 2 &&
    (this.outs[0].isNullOutput() == true);
};
